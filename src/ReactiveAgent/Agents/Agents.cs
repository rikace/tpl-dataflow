...
namespace ReactiveAgent.Agents
{
    ...
    {
        public static IAgentRx<TMessage, TResult> StartWithRx<TMessage, TResult>(TResult initialState, Func<TResult, TMessage, TResult> action, CancellationTokenSource cts = null)
            => new Agent<TMessage, TResult>(initialState, action, cts);
        ...
        public static IDisposable LinkTo<TOutput, TState>(this ISourceBlock<TOutput> source, IAgentRx<TOutput, TState> agent)
