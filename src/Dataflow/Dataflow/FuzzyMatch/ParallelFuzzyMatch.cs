...
namespace Dataflow.FuzzyMatch
{
    ...
    using static Dataflow.FuzzyMatch.FuzzyMatchHelpers;
   ...
   public partial class ParallelFuzzyMatch
    {
        public static async Task RunFuzzyMatchDataFlow(string[] wordsLookup, IList<string> files)
        {
            ...
            var foundMatchesBlock =
                new TransformBlock<HashSet<string>[], JaroWinklerModule.FuzyMatchStructures.WordDistanceStruct[]>(
                    async wordSet =>
                    {
            ...
            var printBlock =
                new ActionBlock<JaroWinklerModule.FuzyMatchStructures.WordDistanceStruct[]>(
        ...
        public static async Task RunFuzzyMatchAgentCSharp(string[] wordsLookup, IList<string> files)
        {
            ...
            var foundMatchesBlock =
                new TransformBlock<string[], JaroWinklerModule.FuzyMatchStructures.WordDistanceStruct[]>(
                    async wordSet =>
                    {
                        var matches =
            ...
            var agent = Agent.StartWithRx(new Dictionary<string, HashSet<string>>(),
                (Dictionary<string, HashSet<string>> state,
                    JaroWinklerModule.FuzyMatchStructures.WordDistanceStruct[] matches) =>
                {
