namespace Dataflow.WebCrawler
{
    ...
    using Dataflow.BenchPerformance;

    public class WebCrawlerExample
    {
        public static Func<string, IEnumerable<string>> WebCrawlerMemoized = Memoization.Memoize<string, IEnumerable<string>>(WebCrawler);
